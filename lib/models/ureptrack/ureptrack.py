...
from lib.models.ureptrack.vit import vit_base_patch16_224
from lib.models.ureptrack.vit_ce import vit_large_patch16_224_ce, vit_base_patch16_224_ce

from lib.models.ureptrack.poolformer import poolformer_s24_vitfmt

from lib.utils.box_ops import box_xyxy_to_cxcywh
from lib.models.layers.transformer import build_transformer

class UREPTrack(nn.Module):
    """ This is the base class for ureptrack """
...
def build_ureptrack(cfg, training=True):
    current_dir = os.path.dirname(os.path.abspath(__file__))  # This is your Project Root
    pretrained_path = os.path.join(current_dir, '../../../pretrained_models')
    if cfg.MODEL.PRETRAIN_FILE and ('UREPTrack' not in cfg.MODEL.PRETRAIN_FILE) and training:
    ...
    elif cfg.MODEL.BACKBONE.TYPE == 'poolformer':
        backbone = poolformer_s24_vitfmt()
        hidden_dim = backbone.embed_dim
        patch_start_index = 1
    ...
    if 'UREPTrack' in cfg.MODEL.PRETRAIN_FILE and training:
